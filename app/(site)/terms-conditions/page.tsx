            ...
            <div className="h-full overflow-auto">
              <div className="h-full">
                ...
                <ul className="text-sm font-generalsans-r ml-4 flex flex-col gap-1.5 mb-5">
                  ...
                  <a href="/terms-conditions#User-Account">
                    <li className="cursor-pointer">2. User Account</li>{" "}
                  </a>
                  <a href="/terms-conditions#Job-Search">
                    <li className="cursor-pointer">3. Job Search</li>{" "}
                  </a>
                  <a href="/terms-conditions#Remote-Work">
                    <li className="cursor-pointer">4. Remote Work</li>{" "}
                  </a>
                  <a href="/terms-conditions#Payment">
                    <li className="cursor-pointer">5. Payment</li>{" "}
                  </a>
                  <a href="/terms-conditions#Intellectual-Property">
                    <li className="cursor-pointer">6. Intellectual Property</li>{" "}
                  </a>
                  <a href="/terms-conditions#User-Conduct">
                    <li className="cursor-pointer">7. User Conduct</li>{" "}
                  </a>
                  <a href="/terms-conditions#Indemnification">
                    <li className="cursor-pointer">8. Indemnification</li>{" "}
                  </a>
                  <a href="/terms-conditions#Disclaimer-of-Warranties">
                    <li className="cursor-pointer">
                      9. Disclaimer of Warranties
                    </li>{" "}
                  </a>
                  <a href="/terms-conditions#Limitation-of-Liability">
                    <li className="cursor-pointer">
                      10. Limitation of Liability
                    </li>{" "}
                  </a>
                  <a href="/terms-conditions#Governing-Law">
                    <li className="cursor-pointer">11. Governing Law</li>{" "}
                  </a>
                  <a href="/terms-conditions#Changes-to-Terms-and-Conditions">
                    <li className="cursor-pointer">
                ...
                <ul className="text-sm font-generalsans-r ml-4 flex flex-col gap-1.5">
                  ...
                  <a href="/terms-conditions#job-posting">
                    <li className="cursor-pointer">3. Job Postings</li>{" "}
                  </a>
                  <a href="/terms-conditions#candidate-selection">
        ...
        <div className="font-generalsans-r">
          ...
          <div className="mb-4">
            ...
            <p>
              ...
              background checks or interviews. <strong>Hyring.com</strong>does
              not guarantee the suitability or qualifications of any candidate.
            </p>
          </div>
          <div className="mb-4">
            <p className="font-generalsans-m text-lg mb-2" id="remote-work">
