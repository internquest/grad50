    ...
    <div className=" w-full relative  md:pt-2 lg:pt-3 2xl:pt-4">
      <div className="      w-fit  cursor-pointer m-auto  relative  ">
        ...
        <div
          ...
          className={twMerge(" bg-[#b6eccc] z-10  mx-auto  w-[93%]    xs:w-[340px] sm:w-[400px] md:w-[340px] lg:!w-[500px]  !justify-start border-2  rounded-[16px] border-primary-brown flex justify-center items-center relative   ", props.className)}
        >
          <div className="scale-[0.6] md:scale-[.7] lg:scale-[0.9] xl4:scale-[1] absolute -top-8 -right-4 md:-right-8  ">
            {/* start */}

            <Image src={props.startimage || greenstarts} width={800 / 2} height={400 / 2} className="w-fit animate-spin-slow" alt="image" />
          </div>
          <div className=" md:pl-8  px-3 md:pr-5 py-5  flex flex-col  justify-start items-start">
            ...
            <p className=" !leading-[2] tracking-[.015em] mt-2 text-[14px] lg:text-lg xl4:text-[26px] xl4:pt-5 font-generalsans-m">
              {props.description}
            </p>
          </div>
        </div>
        <div
          className="mx-auto  w-[9%] sm:w-[400px] md:w-[340px] lg:!w-[500px] 
