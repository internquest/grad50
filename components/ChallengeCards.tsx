...
const ChallengeCards = () => {
    return (
        <div className=' -mt-[100px] z-10 relative'>
            <div className='bg-white max-w-[1054px] min-h-[475px] mx-auto rounded-[20px] py-4 pt-8 px-10 border-[#462B34] border-[length:2px_2px_7px_2px]'>
                <div className='w-full h-full flex gap-5'>
                    <div className='flex flex-col gap-4 basis-[70%] justify-start'>
                    ...
                    <div className='basis-[30%] flex flex-col gap-4 items-center justify-center'>
