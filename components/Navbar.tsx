        ...
        <div className="pt-[14px]">
          <div className="undefined mx-auto min-h-[67px] w-fit md:min-h-[102px]   relative  ">
            ...
            <div className="w-[95vw] min-h-[63px] md:min-h-[93px] border-2 bg-custom-bg rounded-[10px] border-primary-brown 2xl:max-w-[1800px] 2xl:mx-auto 2xl:my-0 flex justify-center items-center relative z-1 ">
              ...
              <div className="flex w-full  items-center justify-between px-5 font-WhyteInktrap-medium text-[17px] md:px-8 xl:px-10 xl:text-xl     ">
                ...
                <div className="flex gap-6 flex-col lg:flex-row py-3">
                  <div onClick={() => handlebar()} className="md:flex md:gap-4 lg:gap-8 items-center hidden xl:gap-10 ">
                    <Link
                      href={"/about-us"}
                      className={`btn relative   lg:text-inherit decoration-inherit`}
                    >
                    ...
                    >
                      <p className={`inline-block ${path === 'about-us' ? "btn-active " : ""} relative m-0`}>students</p>
                    </Link>
            ...
            <div
              className="w-full h-[63px] md:h-[123px] lg:h-[94px] -z-10 rounded-[10px] bg-primary-brown    absolute  "
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              >
                <Link href={"/about-us"} className="text-inherit decoration-inherit">
                  <p className="inline-block relative m-0">About Us</p>
                </Link>
                <Link href={"#"} className="text-inherit decoration-inherit">
                  <p className="inline-block relative m-0">Pricing</p>
                </Link>
                <Link href={"/students"} className="text-inherit decoration-inherit">
                  <p className="inline-block relative m-0">students</p>
                </Link>
                <Link href={"#"} className="text-inherit decoration-inherit">
                  <p className="inline-block relative m-0">Contact Us</p>
                </Link>
